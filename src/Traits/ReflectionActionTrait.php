...
trait ReflectionActionTrait
{
    ...
    abstract public function reflectionToParameters(ReflectionFunction|ReflectionMethod $reflection): ParametersInterface;

    abstract public function reflectionToReturn(ReflectionFunction|ReflectionMethod $reflection): ParameterInterface;
